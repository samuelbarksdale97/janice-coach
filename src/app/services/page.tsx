            ...
            <main className="flex-1">
                <section className="w-full py-12 md:py-16 lg:py-20 bg-background">
                    <div className="container grid gap-10 lg:grid-cols-2 lg:gap-16 items-center px-4 md:px-6">
                        <div className="space-y-4 text-center lg:text-left animate-glide-left">
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                <h2 className="text-3xl font-headline font-bold tracking-tighter text-primary sm:text-5xl">Your Coaching Journey</h2>
